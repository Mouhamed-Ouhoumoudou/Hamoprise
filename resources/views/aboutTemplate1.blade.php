            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <!--<a class="nav-link nav-link-2" href="videos.html">Videos</a>-->
                                       <?php 
                   echo '<a class="nav-link nav-link-3 active" href="/about-template1?id='. $_GET['id'].'">A propos</a>';
                   ?>
                </li>
                <li class="nav-item">
                   <?php 
    ...
    <div class="container-fluid tm-mt-60">
        ...
        <div class="row tm-mb-74 tm-row-1640">            
            <div class="col-lg-5 col-md-6 col-12 mb-3">
                <!--<img src="template1/img/abou.jpg" alt="Image" class="img-fluid">-->
                <?php
                // <img style="height:40px; width: 40px;  margin-left:7px; position:fixed;border-radius:50px;" src="storage/MarkImages/'.$nom1.'" alt="logo de profil">
         $nom1=substr(Boutique::find($_GET['id'])->photo_profil, 11);               echo '<img src="storage/MarkImages/'.$nom1.'" alt="Image" class="img-fluid">'
                ?>
            </div>
