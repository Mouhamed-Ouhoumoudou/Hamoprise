...
.u-section-1 .u-text-1 {
 ...
 <link href="/css/app.css" rel="stylesheet">
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Hamoprise, Connexion">
    <meta name="description" content="">
    <title>Payement Reussi</title>
...
<link rel="stylesheet" href="Contact.css" media="screen">
    ...
    <script type="application/ld+json">{
		...
		"@type": "Organization",
		"name": "",
		"logo": "images/smiling-athlete-1.jpg",
		"sameAs": []
}</script>
  ...
  <body class="u-body u-xl-mode" data-lang="fr"><header class="u-clearfix u-header u-palette-2-base u-valign-middle-md u-header" id="sec-72b9"><img class="u-align-left u-image u-image-round u-radius-10 u-image-1" data-image-width="1000" data-image-height="1000" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="250" src="images/logo-kassouwa-new2.png"><h2 class="u-text u-text-default u-text-1">Hamoprise</h2><nav class="u-menu u-menu-one-level u-offcanvas u-menu-1">
        ...
        <div class="u-custom-menu u-nav-container">
          <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-hover-white u-text-white" href="/inscription" data-lang-fr="{&quot;content&quot;:&quot;Creer une boutique&quot;,&quot;href&quot;:&quot;Accueil.html&quot;}" style="padding: 10px 6px;">Creer une Boutique</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-hover-white u-text-white" href="#" data-lang-fr="{&quot;content&quot;:&quot;se connecter&quot;,&quot;href&quot;:&quot;À-propos-de.html&quot;}" style="padding: 10px 2px 10px 6px;">Se connecter</a>
</li></ul>
        </div>
        <div class="u-custom-menu u-nav-container-collapse">
          <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
            <div class="u-inner-container-layout u-sidenav-overflow">
              ...
              <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Accueil.html" data-lang-fr="{&quot;content&quot;:&quot;Creer une boutique&quot;,&quot;href&quot;:&quot;Accueil.html&quot;}">Creer une Boutique</a>
      ...
      </nav><form action="#" method="get" class="u-radius-20 u-search u-search-left u-white u-search-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-f1e8">
      <div class="u-clearfix u-sheet u-sheet-1">

          <div style="background-color:green;">
              <h2 class="u-text u-text-default u-text-1">Achat effectué avec Succès.</h2>
               <?php
...
try {
  ...
  $id_P=intval(get_between($_GET['session_id'], "\"debut\"", "a123"));
...
$produit=Produit::find($id_P);
          $achat= new Achat();
              ...
              $achat->adresseLivraison="null";
              $achat->telephone="null";
              $achat->email="null";
              $achat->nomClient=$customer->name;
              $achat->session_id=$_GET['session_id'];
              $achat->save();
              $boutique=Boutique::find($produit->id_B);
              /*une faille de securité a regler plutart,en effet si le vendeur augment le prix de ce produit juste apres la transaction, il gagnera donc des prix suplementaire coté Hamoprise alos que le client n'a pas payé ce prix coté stripe */
         $boutique->solde=$boutique->solde+$produit->prix;
         $boutique->nbCommandeRecu=$boutique->nbCommandeRecu+1;
         $boutique->save();
         $nom=substr($produit->url_photo, 7);
         echo '<img src="/storage/images/'.$nom.'" style="width:400px;height:400px>';
         echo '<h2>';
...
$mail->Subject = 'Confirmation d\'achat pour article '.$produit->libelle.'';
$mail->Body    = 'vous avez achete ce article '.$produit->libelle.', '.$produit->prix.' euro!</b>';
