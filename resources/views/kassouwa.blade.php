...
<!--    OneSignal.init({-->
<!--      appId: "b758658d-8589-4733-8149-9a6956f93cbe",-->
<!--    });-->
<!--  });-->
<!--</script>-->
  ...
  color: #fff;">
      ...
      <h2 class="u-text u-text-default u-text-1">Hamoprise</h2><nav class="u-menu u-menu-one-level u-offcanvas u-menu-1 u-enable-responsive">
        ...
        <div class="u-custom-menu u-nav-container">
          <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-hover-white u-text-white active" href="/inscription" data-lang-fr="{&quot;content&quot;:&quot;Creer une boutique&quot;,&quot;href&quot;:&quot;Accueil.html&quot;}" style="padding: 10px 6px;">Creer une Boutique</a>
    ...
    //   pour le pays de visiteurs
            ...
            <div class="u-container-layout u-similar-container u-valign-bottom-md u-valign-top-xl u-container-layout-1">
            <img src="storage/MarkImages/'.$markImage.'" alt="" class="u-image u-image-round u-radius-10 u-image-1" data-href="/boutique?id='.$boutique->id.'." title="boutique">
            
                <a href="/boutique?id='.$boutique->id.'." class="u-border-none u-btn u-button-style u-none u-text-palette-2-base u-btn-1">'.$boutique->nom_B.'</a>
                              <h6 class="u-text u-text-default u-text-palette-1-base u-text-1">
                <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-2" href="/boutique?id='.$boutique->id.'."><span class="u-file-icon u-icon u-text-palette-1-base"><img src="css/images/1337055-4e4c4500.png" alt=""></span>&nbsp;'.$boutique->Nbr_Produit.'articles
                </a>
              </h6>
              <h6 class="u-text u-text-default-xs u-text-2"><span class="u-file-icon u-icon u-text-palette-5-dark-2"><img src="images/619-f432a22f.png" alt=""></span>&nbsp;Paris,France
              </h6>
            </div>
          </div>
          ';
            ...
            <img src="storage/MarkImages/'.$markImage.'" alt="" class="u-image u-image-round u-radius-10 u-image-1" data-href="/boutique?id='.$boutique->id.'." title="boutique">
              ...
              <h6 class="u-text u-text-default-xs u-text-2"><span class="u-file-icon u-icon u-text-palette-5-dark-2"><img src="css/images/619-f432a22f.png" alt=""></span>&nbsp;Paris,France
              </h6>
            </div>
          </div>';
                   }
                  ...
                  <div data-position="" class="u-position"><!--block-->
                    <div class="u-block">
                      <div class="u-block-container u-clearfix"><!--block_header-->
                        <h5 class="u-block-header u-text"><!--block_header_content--> Hamoprise <!--/block_header_content--></h5><!--/block_header--><!--block_content-->
                        <div class="u-block-content u-text"><!--block_content_content--> 
Hamoprise est une place de marché virtuelle pour vendeurs et commerçants,une alternative à la création de sites de vente, permettant aux commerçants de vendre rapidement leurs produits et leurs fonds sont automatiquement transférés sur leurs coordonnées bancaires. . <!--/block_content_content--></div><!--/block_content-->
                      </div>
                    </div><!--/block-->
                  </div><!--/position-->
                </div>
