...
<head>
    ...
    // $request->session()->put('boutiquePub',$boutique);
    Session::put('boutiquePub', $boutique->id);
    ?>
    </title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <!--viste dans la boutique-->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> 
<script>
document.getElementById('boutique_Global').style.display="none";
document.onload = function(){ 
};
window.addEventListener('load',() => {

  var id = document.getElementById('boutique_Global').value;
...
{{ @csrf_field() }}
        ...
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                <form action="" class="tm-text-primary">
                    <?php
                  echo '  Plus de <input type="text" value="'.Boutique::find($_GET['id'])->Nbr_Produit.'" size="1" class="tm-input-paging tm-text-primary"> Articles
                  ';
                    ?>
                </form>
            </div>
  ...
  use Illuminate\Support\Facades\DB;
   ...
   if(isset($_GET['id'])){
         $produits=DB::table('produits')->where('id_B',$_GET['id'])->get();
