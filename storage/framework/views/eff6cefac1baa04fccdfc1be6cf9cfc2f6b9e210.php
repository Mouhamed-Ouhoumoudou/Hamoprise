...
<?php  use App\Models\Boutique;
 ...
 if(session('client')==1){
     ...
     echo '<header ><a href=""><img style="width:120px; height:20px;position:fixed;" src="/images/triangle.png"><br><img style="height:70px; width: 100px; margin-left:7px; position:fixed;" src="'.Boutique::find(session("id_B"))->photo_profil.'" alt="logo de profil"></a></header><br><br><br><br><hr>';
...
echo '<br><br>
<div id="boite">';
echo '<div class="produit-grand">
<img  class="produit-image"  alt="une image d un produit" src="/storage/images/'.$nom.'">
</div>
<div style="float:right;">


<div class="desc-produit"><p>'.$produit->libelle.'</p>
<p class="desc-produit-texte">'.$produit->description.'</p>
<h2>'.$produit->prix.' Fcfa<span style="background-color:#FF9888;color:white; border-radius:3px;">New</span></h2></div>';
echo "</div>
</div>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('base_boutique', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mouha\OneDrive\Documents\Laravel\Laravel\kassouwa\resources\views/produit.blade.php ENDPATH**/ ?>