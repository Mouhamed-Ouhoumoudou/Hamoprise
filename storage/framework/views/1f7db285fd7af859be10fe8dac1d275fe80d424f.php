...
<?php $__env->startSection('compte'); ?>
            ...
            <div class="compte"> 
             <button class="inscription"><a href="/inscription">creer une boutique</a></button>
                <button class="inscription"><a href="/connexion">se connecter</a></button>
            </div>
 <?php $__env->stopSection(); ?>           
 ...
 -->
       ...
       /* affichage des boutiques */
               foreach($boutiques as $boutique){
                ...
                echo '<a style="display:inline-block;margin:10px;" target="_blank" href="/boutique?id='.$boutique->id.'."><figure><img  class="triangle"  src="/images/triangle.png"><br><img class="boutique-photo" src="'.$boutique->photo_profil.'" alt="logo de profil"></figure><h2 class="nom-boutique" >'.$boutique->nom_B."</h2></a>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mouha\Documents\Laravel\kassouwa\resources\views/kassouwa.blade.php ENDPATH**/ ?>