<?php 
 ...
 <head>
    ...
    <link rel="icon" type="image/jpeg" sizes="16x16" href="/images/kassouwa-new.jpeg.png">
    <style >
    header{
...
margin-left: 1px;
  ...
  .recherche{
    ...
    .nom-boutique{
    color:black; padding-left:75px;float: right;margin-bottom: px;
}
 ...
 <body style="background-color: #FFFFF0;">
    ...
    <header>
            ...
            <a style="text-decoration: none;" href="/"><img class="kassouwa-logo" style="height:70px;border-radius: 7px;" src="/images/kassouwa-new.jpeg.png" alt="logo de kassouwa">
                
                <h3 class="nom-kassouwa" id="nom-kassouwa">Kassouwa</h3>
                                        
            <?php echo $__env->yieldContent('compte'); ?>

            </a>
             <input  class="btn-mobile-menu" id="btn-mobile-menu" type="image" name="btn-mobile-menu" src="images/btn_mobile_menu.png"   onclick="menu()">
...
?><br><br><button>chaussure</button><br><br><button>maquiage</button></div></a></div>
 ...
 </html><?php /**PATH C:\Users\mouha\Documents\Laravel\kassouwa\resources\views/base.blade.php ENDPATH**/ ?>