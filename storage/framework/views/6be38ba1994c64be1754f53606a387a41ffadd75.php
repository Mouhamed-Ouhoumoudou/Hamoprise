...
<fieldset align=center>
	<form action="<?php echo e(url('/inscription/ajouter')); ?>" method="post">
		...
		<input type="text" name="nom_B" id="nom_B" maxlength="30" pattern=""  placeholder="Nom" onclick="label('nom:')" required><br><br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mouha\Documents\Laravel\kassouwa\resources\views/inscription.blade.php ENDPATH**/ ?>